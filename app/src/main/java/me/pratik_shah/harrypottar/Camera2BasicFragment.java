...
import me.pratik_shah.harrypottar.view.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            SparseArray<Barcode> detectedResult = mBarcodeDetector.detect(frame);
            Log.d("MessageFromDobby", "Detected Result Size: " + detectedResult.size());
            if (detectedResult.size() != 0) {
                analyseDetectionResult(detectedResult);
            }
        }
    };
    ...
    private boolean isQRCodePresent(SparseArray<Barcode> detectedResult) {
        for (int i = 0; i < detectedResult.size(); i++) {
            ...
            if (value.rawValue.equals(getActivity().getString(R.string.qr_code))) {
                return true;
            }
        }
        return false;
    ...
    private void startOverlay() {
        ...
        ((MessageFromDobby2) (getActivity())).getMessage(true).sendToTarget();
    }


    private void stopOverlay() {
        Log.d("MessageFromDobby", "Stopping Overlay");
        ((MessageFromDobby2) (getActivity())).getMessage(false).sendToTarget();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_cameraview, container, false);
    }
